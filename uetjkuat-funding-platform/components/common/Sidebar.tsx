...
const Sidebar: React.FC<SidebarProps> = ({ isOpen, setIsOpen, setRoute, currentRoute, activeTab, setActiveTab }) => {
    const { user, logout } = useAuth();

    // User dashboard modules
    const userModules = [
        { icon: LayoutDashboard, label: 'Overview', tab: 'overview' },
        { icon: Wallet, label: 'My Account', tab: 'account' },
        { icon: CreditCard, label: 'Purchases', tab: 'purchases' },
        { icon: Link2, label: 'Recharge Links', tab: 'recharge' },
        { icon: History, label: 'Transactions', tab: 'transactions' },
    ];
      ...
      `}>
                <div className="flex flex-col h-full">
                    ...
                    <nav className="flex-1 py-4 px-3 space-y-4 overflow-y-auto">
                        ...
                        <div>
                            <p className="text-xs font-semibold text-muted-foreground uppercase tracking-wider mb-2 px-3">My Dashboard</p>
                        ...
                        {/* Profile Section */}
                        <div>
                            <p className="text-xs font-semibold text-muted-foreground uppercase tracking-wider mb-2 px-3">Settings</p>
                            <div className="space-y-1">
                                <button
